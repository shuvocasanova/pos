...
$('.salesTable').DataTable({
 ...
 $(".producttable").on('click','.btnadd',function(){
 	var html='';
 	html+='<tr>';

 	html+='<td><input type="hidden" class="form-control name" name="name[]" readonly></td>';
 	html+='<td><select class="form-control code" name="name[]"><option value="">Select Option</option><?php echo $output ; ?></select></td>';
 	...
 	html+='<td><center><button type="button" name="remove" class="btn btn-danger btnremove btn-sm"><span class="glyphicon glyphicon-remove"></span></button></center></td>';
